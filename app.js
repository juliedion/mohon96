...
const APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbwyezMpSgljqnH6licBxqpomcfQQXIZNYukrDOC6VnS1w1k7w5mGwpaC5WGK9sBrA3Y/exec';
...
const CLASSMATES = [
  ...
  { id:6,     first:'Ida-Jo',                    mid:'M.',        last:'Barone',                  suf:'',      full:'Ida-Jo M. Barone',                          status:'portrait',    page:1,  email:'aWRham9zdWRhbm9AeWFob28uY29t',   married:'Sudano',    facebook:'https://www.facebook.com/jo.sudano/'  },
  ...
  { id:34,    first:'Kathleen',                  mid:'M.',        last:'Dennis',                  suf:'',      full:'Kathleen M. Dennis',                        status:'portrait',    page:3,  email:'a21kNzgzNEBtc24uY29t',   married:'Vest',      facebook:'https://www.facebook.com/kathy.vest.37/'  },
  ...
  { id:75,    first:'Loretta',                   mid:'',          last:'Haynes',                  suf:'',      full:'Loretta Haynes',                            status:'portrait',    page:6,  email:'bGlseWxtdEBhb2wuY29t',   married:'Murray',    facebook:'https://www.facebook.com/loretta.murray.50/'  },
  { id:76,    first:'Johna',                     mid:'A.',        last:'Higgins',                 suf:'',      full:'Johna A. Higgins',                          status:'missing',     page:6  },
  { id:77,    first:'Tracie',                    mid:'L.',        last:'Holland',                 suf:'',      full:'Tracie L. Holland',                         status:'portrait',    page:6,  married:'Nichols',   facebook:'https://www.facebook.com/tracie.holland'  },
  ...
  { id:96,    first:'Sean',                      mid:'W.',        last:'Lasher',                  suf:'',      full:'Sean W. Lasher',                            status:'portrait',    page:8,  facebook:'https://www.facebook.com/sean.lasher.5/'  },
  ...
  { id:174,   first:'Amanda',                    mid:'',          last:'Sanger',                  suf:'',      full:'Amanda Sanger',                             status:'portrait',    page:13, email:'YW1hbmRhLnNhbmdlckBnbWFpbC5jb20=',   married:'Lomanto',   facebook:'https://www.facebook.com/mandamelle/'  },
  ...
  { id:202,   first:'Joseph',                    mid:'',          last:'Villano',                 suf:'',      full:'Joseph Villano',                            status:'portrait',    page:15, facebook:'https://www.facebook.com/joe.villano.7/'  },
